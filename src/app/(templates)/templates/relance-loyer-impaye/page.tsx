...
const etapesRelance = [
  ...
  },
  {
    ...
    description:
      "Si le retard persiste, envoyez un courrier (ou email) rappelant le montant dû et la date limite de règlement.",
  },
  {
    etape: "4",
...
const protectionsLocataire = [
  "Le locataire est protégé pendant la trêve hivernale (1er novembre - 31 mars) : aucune procédure d'expulsion ne peut être engagée.",
...
const faqData = [
  {
    ...
    answer:
      "Techniquement, dès le jour où le loyer n'est pas payé à la date prévue dans le bail. En pratique, on attend généralement 5 à 10 jours pour laisser le temps à la transaction d'être traitée. Passé 30 jours, il est recommandé d'engager la procédure de relance formelle pour préserver vos droits.",
  },
  {
    question:
      "La mise en demeure doit-elle être envoyée en recommandé avec accusé de réception ?",
    answer:
      "Oui, la mise en demeure doit être adressée par lettre recommandée avec accusé de réception pour avoir une valeur juridique. Elle constitue le point de départ du délai de 30 jours avant application de la clause résolutoire. Conservez une copie cachetée par La Poste.",
  },
  {
    question:
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Relance loyer impayé", item: "https://www.rentready.fr/templates/relance-loyer-impaye" },
        ],
      },
      {
        "@type": "HowTo",
      ...
      <article className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <header className="mb-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-stone-600">
            ...
            Relance amiable et mise en demeure, prêt à personnaliser et à envoyer
            en recommandé.
          </p>
        ...
        <section className="mb-16 rounded-2xl border border-stone-200 bg-white p-8 sm:p-10">
          ...
          <p className="mb-4 text-stone-700">
            ...
            rapide et documentée est essentielle.
          </p>
          <p className="mb-4 text-stone-700">
        ...
        <section className="mb-16 rounded-2xl bg-blue-50 p-8 sm:p-10">
          ...
          <p className="mb-4 text-stone-700">
            La mise en demeure est le document officiel qui marque le passage à
            une étape juridique sérieuse. Elle doit contenir les éléments
        ...
        <section className="mb-16 rounded-2xl border border-stone-200 bg-white p-8 sm:p-10">
          ...
          <p className="mb-6 text-stone-700">
            Si le locataire ne paie toujours pas malgré la mise en demeure, voici la
            procédure à suivre :
          </p>
