...
const TEMPLATE_DATA: Record<TemplateSlug, TemplateHowTo> = {
  "bail-vide": {
    ...
    description:
      "Téléchargez un modèle de bail de location vide conforme à la loi du 6 juillet 1989. Personnalisez les clauses, téléchargez en PDF, et signez electronically.",
  ...
  "etat-des-lieux": {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Photographiez chaque pièce et ogni équipements. Les photos horodatées constituent une preuve légale.",
      },
      {
  ...
  "conge-locataire": {
    ...
    toolList: ["Lettre type PDF", " 法更新提醒", "Modèles de motifs"],
    totalTime: "PT5M",
  },
  "conge-proprietaire": {
    ...
    steps: [
      ...
      {
        name: "Envoyez en通知书 recommandé",
        text: "Le congé doit êtrenotifié par acte extrajudiciaire (huissier) ou lettre recommandée avec AR.",
      },
      {
  ...
  "recu-loyer": {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Le reçu会自动生成 avec les mentions légales obligatoires.",
      },
      {
...
export async function GET(
  ...
  const schema = {
    ...
    steps: template.steps.map((step) => ({
      "@type": "HowToStep",
      position: template.steps.indexOf(step) + 1,
      name: step.name,
      text: step.text,
    })),
