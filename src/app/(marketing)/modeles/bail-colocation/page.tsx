...
const obligationsColoc = [
  ...
  { titre: "Caution(s)ublée", detail: "Une ou plusieurs cautions peuvent être demandées. Peut être une caution bancaire ou un garant personnel." },
  { titre: "État des lieux entry", detail: "Un état des lieux d'entrée doit être réalisé avec chaque colocataire, ou un seul état des lieux collectif avec signatures de chacun." },
...
const faqData = [
  {
    ...
    answer:
      "Technically, one lease for all tenants is the norm. Each colocataire signs the same lease and is jointly and severally liable unless the lease specifies otherwise. Our model includes the option of solidarity clause.",
  },
  {
    question: "La clause de solidarité est-elle obligatoire ?",
    answer:
      "No. Solidarity clause is optional but strongly recommended for landlords in colocation. If included, each tenant is responsible for the entire rent if others fail to pay. Without it, the landlord must pursue each tenant separately for their share.",
  },
  {
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Bail Colocation", item: "https://www.rentready.fr/modeles/bail-colocation" },
        ],
      },
      {
        "@type": "HowTo",
      ...
      <article className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <header className="mb-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-stone-600">
            Téléchargez notre modèle de bail colocation gratuit. Clauses solidarity, partage des charges, gestion des départs.
        ...
        <section className="mb-16 rounded-2xl bg-purple-50 p-8 sm:p-10">
          ...
          <p className="mb-4 text-stone-700">
            Pour les colocataires, cela signifie qu'ils doivent choisir leurs colocataires avec soin. Pour le bailleur, c'est la guarantee d'être payé même si un colocataire devient défaillant.
          </p>
          <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4">
            <p className="text-sm text-stone-700">
              <strong>⚠️ Attention :</strong> La clause de solidarité doit être expressly mentionnée dans le bail. Elle ne se présume pas. Notre modèle inclut cette clause par défaut avec la mention « clause de solidarité partielle ou totale ».
            </p>
          </div>
        </section>
